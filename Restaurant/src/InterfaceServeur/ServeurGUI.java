...
public class ServeurGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Espace Serveur");
        ...
        jButton2.setText("Gestion des Paiments");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        JFrame Commandes = new JFrame("Restaurant ~MoHa~");
        Commandes.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Allow the frame to be closed
        Commandes.setResizable(false);
        ...
        Commandes.getContentPane().add(Panel);

        // Set the size of the JFrame
        Commandes.setSize(700, 500);

        // Center the frame on the screen
        Commandes.setLocationRelativeTo(null);

        // Set the JFrame to be visible
        Commandes.setVisible(true);

        // Close the current Serveur frame
        JFrame serveurFrame = (JFrame) SwingUtilities.getWindowAncestor(this);
        serveurFrame.dispose();
    }

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
        JFrame Reservations = new JFrame("Restaurant ~MoHa~");
        Reservations.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Allow the frame to be closed
        Reservations.setResizable(false);

        // Create an instance of the GestionCommandes panel
        GestionReservation Panel = new GestionReservation();

        // Add the GestionCommandes panel to the JFrame
        Reservations.getContentPane().add(Panel);

        // Set the size of the JFrame
        Reservations.setSize(700, 500);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        JFrame Paiment = new JFrame("Restaurant ~MoHa~");
        Paiment.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Allow the frame to be closed
        Paiment.setResizable(false);

        // Create an instance of the GestionCommandes panel
        GestionPaiment Panel = new GestionPaiment();

        // Add the GestionCommandes panel to the JFrame
        Paiment.getContentPane().add(Panel);

        // Set the size of the JFrame
        Paiment.setSize(700, 500);

        // Center the frame on the screen
        Paiment.setLocationRelativeTo(null);

        // Set the JFrame to be visible
        Paiment.setVisible(true);
