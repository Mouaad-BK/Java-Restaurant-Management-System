...
public class GestionCommandes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gestion des Commendes");
        ...
        jButton2.setText("Ajouter plat à une Commande");
        ...
        jButton6.setText("Retirer Plat d'une Commande");
        ...
        jButton7.setText("Finaliser Commande");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        JFrame command = new JFrame("Restaurant ~MoHa~");
        command.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Allow the frame to be closed
        command.setResizable(false);

        // Create an instance of the GestionCommandes panel
        CreerCommande Panel = new CreerCommande();

        // Add the GestionCommandes panel to the JFrame
        command.getContentPane().add(Panel);

        // Set the size of the JFrame
        command.setSize(700, 500);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {
        JFrame suprimplatframe = new JFrame("Restaurant ~MoHa~");
        suprimplatframe.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Allow the frame to be closed
        suprimplatframe.setResizable(false);

        // Create an instance of the GestionCommandes panel
        RetirerPlatCommande Panel = new RetirerPlatCommande();

        // Add the GestionCommandes panel to the JFrame
        suprimplatframe.getContentPane().add(Panel);

        // Set the size of the JFrame
        suprimplatframe.setSize(700, 500);

        // Center the frame on the screen
        suprimplatframe.setLocationRelativeTo(null);

        // Set the JFrame to be visible
        suprimplatframe.setVisible(true);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {
        JFrame finaleserfrem = new JFrame("Restaurant ~MoHa~");
        finaleserfrem.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Allow the frame to be closed
        finaleserfrem.setResizable(false);

        // Create an instance of the GestionCommandes panel
        FinaliserCommande Panel = new FinaliserCommande();

        // Add the GestionCommandes panel to the JFrame
        finaleserfrem.getContentPane().add(Panel);

        // Set the size of the JFrame
        finaleserfrem.setSize(700, 500);

        // Center the frame on the screen
        finaleserfrem.setLocationRelativeTo(null);

        // Set the JFrame to be visible
        finaleserfrem.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        JFrame platframe = new JFrame("Restaurant ~MoHa~");
        platframe.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Allow the frame to be closed
        platframe.setResizable(false);

        // Create an instance of the GestionCommandes panel
        AjouterPlatCommande Panel = new AjouterPlatCommande();

        // Add the GestionCommandes panel to the JFrame
        platframe.getContentPane().add(Panel);

        // Set the size of the JFrame
        platframe.setSize(700, 500);
